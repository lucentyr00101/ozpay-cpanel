...
import { getLocale, useIntl, useAccess } from 'umi';
...
const AccountTransactionDetails: FC<Props> = ({ visible, close, currentRow }) => {
  ...
  const hideAgentInfo = !access?.Merchants.AccountTransactionRecords.ShowAgentinfo;
              ...
              columns={[
                {
                  ...
                  dataIndex: ['merchant', 'agentUsername'],
                  hideInDescriptions: hideAgentInfo,
                },
                {
            ...
            <ProDescriptions<AccountTransactionRecordItem>
              ...
              columns={[
                ...
                },
                {
                  ...
                  span: 2,
                  render: (v, entity: any) => {
                    if (entity.remark && entity.remark.indexOf(',') > 0) {
                      return entity.remark.split(',').map((text: string) => {
                        return (
                          <p key={text} style={{ marginBottom: '0' }}>
                            {remarksDict[text]}
                          </p>
                    ...
                    if (entity.remark && remarksDict[entity.remark]) {
                      return <p style={{ marginBottom: '0' }}>{remarksDict[entity.remark]}</p>;
                    }
